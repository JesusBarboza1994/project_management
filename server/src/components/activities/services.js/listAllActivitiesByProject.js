...
async function listAllActivitiesByProject({project, order, search, date, relative_progress}) {
  ...
  return await list_all_activities_of_project({id: project.project, title: project_data[0].title, users: project_data[0].users, filter_order:order, search, date, relative_progress})
